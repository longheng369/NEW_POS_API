    ...
    public function index()
    {
        $variants = Variant::with([
            'product' => function ($query) {
                $query->select('id', 'code', 'name', 'type', 'image', 'status', 'barcode_symbology', 'category_id', 'supplier_id', 'brand_id', 'warehouse_id', 'base_unit_id', 'promotion', 'discount', 'tax_rate', 'details', 'is_perishable', 'created_at', 'updated_at')->with(['category:id,name', 'supplier:id,name', 'brand:id,name', 'warehouse:id,name', 'baseUnit:id,name']);
            },
        ])
    ...
    public function update(Request $request, $id)
    {
        ...
        try {
            ...
            if ($request->boolean('delete_all_variants')) {
                ...
                $product
                    ->variants()
                    ->whereIn('id', $validated['delete_variants'])
                    ->delete();
            }
